...
import com.course.kafka.kafkacoreconsumer.entity.Commodity;
...
public class CommodityDashboardConsumer {
    ...
    public void consume(String message) throws JsonProcessingException, InterruptedException {
        ...
        var randomDelayMilis = ThreadLocalRandom.current().nextLong(500, 2000);
        TimeUnit.MILLISECONDS.sleep(randomDelayMilis);
        LOG.info("Dashboard Login for: {}", commodity);
    }
